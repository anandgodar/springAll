...
<html>
    <head>
		...
		<spring:url value="/resources/vendors/" var="vendorPath" />
		<spring:url value="/resources/js/" var="jsPath" />
        <!-- Bootstrap -->
        <link rel="stylesheet" media="screen" href="${cssPath}bootstrap.min.css">
        <link rel="stylesheet" media="screen" href="${cssPath}bootstrap-theme.min.css">

        <!-- Bootstrap Admin Theme -->
        <link rel="stylesheet" media="screen" href="${cssPath}bootstrap-admin-theme.css">
        <link rel="stylesheet" media="screen" href="${cssPath}bootstrap-admin-theme-change-size.css">

        <!-- Vendors -->
        <link rel="stylesheet" media="screen" href="${vendorPath}easypiechart/jquery.easy-pie-chart.css">
        <link rel="stylesheet" media="screen" href="${vendorPath}easypiechart/jquery.easy-pie-chart_custom.css">

        <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
        <!--[if lt IE 9]>
           <script type="text/javascript" src="${jsPath}html5shiv.js"></script>
           <script type="text/javascript" src="${jsPath}respond.min.js"></script>
        <![endif]-->
    </head>
